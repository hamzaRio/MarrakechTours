    ...
    <section id="contact" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-medium text-gray-800">Contact Our Team</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {contacts.map((contact, index) => (
            <div 
              key={index} 
              className="bg-white rounded-md shadow-sm p-5 text-center hover-lift"
            >
        ...
        {/* Map Section */}
        <div className="mt-12 rounded-md overflow-hidden shadow-md max-w-4xl mx-auto">
          <iframe 
